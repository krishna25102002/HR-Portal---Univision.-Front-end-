...
//   // 🔹 NEW: Interview Type Tabs
//   const [interviewCategory, setInterviewCategory] = useState('internal'); // 'internal' or 'client'
...
//       // 2️⃣ Send email (NO undefined now)
//       await emailsAPI.sendInterview({
//         candidate_email: selectedCandidate.email_id,
...
//                   color: '#fff',
//                   background:
//                     c.status === 'invitation_sent' ? '#28a745' :
//                     c.status === 'scheduled' ? '#ffc107' : '#6c757d'
//                 }}>
//                   {c.status}
//                 </span>
//               </td>
//               <td>
//                 <button style={styles.button} onClick={() => openModal(c)}>
//                   Schedule Interview
//                 </button>
//               </td>
//             </tr>
...
//       {showInterviewerModal && (
//         <div style={styles.backdrop}>
//           <div style={{ ...styles.modal, width: '650px', maxHeight: '80vh', overflowY: 'auto' }}>
//             <div style={styles.modalHeader}>
//               <h3 style={styles.modalTitle}>Manage Interviewers</h3>
//               <button style={styles.closeBtn} onClick={() => setShowInterviewerModal(false)}>✕</button>
//             </div>
...
//               <div style={styles.interviewersList}>
//                 <h4 style={styles.listTitle}>Current Interviewers</h4>
//                 {interviewers.length === 0 ? (
//                   <p style={styles.emptyText}>No interviewers added yet</p>
//                 ) : (
//                   <table style={styles.table}>
