...
// import React, { useEffect, useState } from 'react';
// import { jwtDecode } from 'jwt-decode';
// import { candidatesAPI, interviewsAPI, offersAPI } from '../api/client';
...
//         interviewsScheduled: interviewsRes.data.filter(i => i.status === 'scheduled').length,
//         offersExtended: interviewsRes.data.filter(i => i.status === 'interview').length
//       });
//     } catch (error) {
